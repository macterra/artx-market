...
const config = {
    ...
    notarize_frequency: process.env.NOTARIZE_FREQUENCY || 24,
    notarize_min_fee: process.env.NOTARIZE_MIN_FEE || 1,
    notarize_max_fee: process.env.NOTARIZE_MAX_FEE || 10,
    notarize_rbf_rate: process.env.NOTARIZE_RBF_RATE || 1,
};
